"""
⚠️ ARCHIVO OBSOLETO — NO USAR EN PRODUCCIÓN ⚠️

Este archivo (dashboard_v2.py) ha sido superado por dashboard_v3.py.
No está desplegado ni activo. Se conserva solo como referencia histórica.
Para cualquier modificación o despliegue, utilizar exclusivamente dashboard_v3.py.
